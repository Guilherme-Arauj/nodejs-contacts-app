...
export namespace Prisma {
  ...
  */
  ...
  export type contactsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "contact" | "email" | "picture" | "created_at" | "updated_at", ExtArgs["result"]["contacts"]>
  ...
  interface contactsFieldRefs {
    ...
    readonly picture: FieldRef<"contacts", 'String'>
  ...
  export type contactsWhereInput = {
    ...
    picture?: StringFilter<"contacts"> | string
  ...
  export type contactsScalarWhereWithAggregatesInput = {
    ...
    picture?: StringWithAggregatesFilter<"contacts"> | string
